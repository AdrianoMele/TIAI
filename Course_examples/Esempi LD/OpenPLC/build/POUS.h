...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,SQUARE)

  // FB private variables - TEMP, private and located variables
  __DECLARE_VAR(TIME,TIMEUP)
  __DECLARE_VAR(TIME,TIMEDWN)
  TON TON0;
  TON TON1;
...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,SQUARE)
  __DECLARE_VAR(BOOL,RESETCNT)
  __DECLARE_VAR(INT,CNT)
  MYSQUARE MYSQUARE0;
  CTU CTU0;
  __DECLARE_VAR(BOOL,MYXOR2_OUT)
  R_TRIG R_TRIG1;
