 ...
 * Declare programs 
 **/
extern SENSORI_PIANI RES0__INSTANCE0;
extern PRENOTAZIONI_ESTERNE RES0__INSTANCE3;
extern GESTIONE_MOTORE RES0__INSTANCE2;
extern PRENOTAZIONI_INTERNE RES0__INSTANCE1;

/***
 * Declare global variables from resources and conf 
 **/
extern __IEC_BOOL_t RES0__FLAG;
extern       SENSORI_PIANI   RES0__INSTANCE0;
extern       PRENOTAZIONI_ESTERNE   RES0__INSTANCE3;
extern       GESTIONE_MOTORE   RES0__INSTANCE2;
extern       PRENOTAZIONI_INTERNE   RES0__INSTANCE1;
...
{&(RES0__FLAG), BOOL_ENUM},
{&(RES0__INSTANCE0.SENSOR0), BOOL_ENUM},
...
{&(RES0__INSTANCE3.PULS_0_E), BOOL_ENUM},
{&(RES0__INSTANCE3.PULS_1_E), BOOL_ENUM},
{&(RES0__INSTANCE3.PULS_2_E), BOOL_ENUM},
{&(RES0__INSTANCE3.PULS_3_E), BOOL_ENUM},
...
{&(RES0__INSTANCE3.__action_list[1].state), BOOL_ENUM},
...
{&(RES0__INSTANCE3.__action_list[2].state), BOOL_ENUM},
...
{&(RES0__INSTANCE3.__action_list[3].state), BOOL_ENUM},
{&(RES0__INSTANCE3.__debug_transition_list[7]), BOOL_ENUM},
{&(RES0__INSTANCE2.ACTUATOR), SINT_ENUM},
{&(RES0__INSTANCE2.PORTE), BOOL_ENUM},
{&(RES0__INSTANCE2.SENSOR_PORTE), BOOL_ENUM},
{&(RES0__INSTANCE2.FLAG), BOOL_P_ENUM},
{&(RES0__INSTANCE2.__step_list[0].X), BOOL_ENUM},
{&(RES0__INSTANCE2.__action_list[0].state), BOOL_ENUM},
{&(RES0__INSTANCE2.__debug_transition_list[0]), BOOL_ENUM},
{&(RES0__INSTANCE2.__step_list[1].X), BOOL_ENUM},
{&(RES0__INSTANCE2.__action_list[1].state), BOOL_ENUM},
{&(RES0__INSTANCE2.__debug_transition_list[1]), BOOL_ENUM},
{&(RES0__INSTANCE2.__step_list[2].X), BOOL_ENUM},
{&(RES0__INSTANCE2.__action_list[2].state), BOOL_ENUM},
{&(RES0__INSTANCE2.__debug_transition_list[2]), BOOL_ENUM},
{&(RES0__INSTANCE2.__step_list[3].X), BOOL_ENUM},
{&(RES0__INSTANCE2.__debug_transition_list[3]), BOOL_ENUM},
{&(RES0__INSTANCE2.__debug_transition_list[4]), BOOL_ENUM},
{&(RES0__INSTANCE2.__step_list[4].X), BOOL_ENUM},
{&(RES0__INSTANCE2.__action_list[3].state), BOOL_ENUM},
{&(RES0__INSTANCE2.__debug_transition_list[5]), BOOL_ENUM},
{&(RES0__INSTANCE2.__step_list[5].X), BOOL_ENUM},
{&(RES0__INSTANCE2.__action_list[4].state), BOOL_ENUM},
{&(RES0__INSTANCE2.__debug_transition_list[6]), BOOL_ENUM},
{&(RES0__INSTANCE1.FLAG), BOOL_P_ENUM},
...
{&(RES0__INSTANCE1.__action_list[2].state), BOOL_ENUM},
...
{&(RES0__INSTANCE1.__action_list[3].state), BOOL_ENUM},
