...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->TEMPOPROGRAMMATO,__time_to_timespec(1, 0, 0, 0, 0, 0),1)
  ...
  __INIT_VAR(data__->NUM,10,retain)
  F_TRIG_init__(&data__->F_TRIG1,retain);
...
#define __SFC_SIMACCMAN 1
#define __SFC_SIMULAZIONETASTOON 2
#define __SFC_RISCALDAMENTOMACCHINA 3
#define __SFC_SIMULAZIONETASTOEMERGENZA 4
#define __SFC_SVUOTANASTRO 5
#define __SFC_CONTROLLOLAMA 6
#define __SFC_CONTROLLOSTAMPAACALDO 7
#define __SFC_CARICO_BUSTA 8
#define __SFC_PRONTA_LAVORAZIONE 9
#define __SFC_PRELAVORAZIONE1NASTRO 10
#define __SFC_FUSTELLATRICE 11
#define __SFC_PRELAVORAZIONE2NASTRO 12
#define __SFC_STAMPACALDO 13
#define __SFC_PREFINELAVORAZIONENASTRO 14
#define __SFC_ACCPROGRAMMATA 15
#define __SFC_LEDROSSO 16
#define __SFC_ATTIVARESETRIPR 17
#define __SFC_ATTIVARESET0 18
#define __SFC_LEDGIALLO 19
#define __SFC_RIPRISTINOX 20
#define __SFC_TEMPOATTESA 21
#define __SFC_VANO 22
#define __SFC_TEMPOATTESA2 23
#define __SFC_TASTOEMERGENZA 24
#define __SFC_TEMPOATTESA3 25
#define __SFC_TASTOON 26
#define __SFC_ATTIVARESET6 27
#define __SFC_TIMEDUMMY1 28
#define __SFC_TASTOCARICOBUSTA 29
#define __SFC_LEDVERDE 30
#define __SFC_ATTIVARESET7 31
#define __SFC_TIMEDUMMY2 32
#define __SFC_STARTLAVORAZIONE 33
#define __SFC_ATTIVARESET 34
#define __SFC_TIMEDUMMY3 35
#define __SFC_ATTIVARESET2 36
#define __SFC_TIMEDUMMY4 37
#define __SFC_ATTIVARESET3 38
#define __SFC_TIMEDUMMY5 39
#define __SFC_ATTIVARESET4 40
#define __SFC_TIMEDUMMY6 41
#define __SFC_ATTIVARESET5 42
#define __SFC_TIMEDUMMY7 43
#define __SFC_ACCENSIONEMAN 44
#define __SFC_ACCENSIONEAUT 45
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  // STEP0 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,__action_list[__SFC_SIMACCMAN].state,,1);};
    if (desactivated) {__SET_VAR(data__->,__action_list[__SFC_SIMACCMAN].state,,0);};

  }

  // ACCENSIONEMANUALE action associations
  {
    char active = __GET_VAR(data__->ACCENSIONEMANUALE.X);
    char activated = active && !data__->ACCENSIONEMANUALE.prev_state;
    char desactivated = !active && data__->ACCENSIONEMANUALE.prev_state;

    if (active)       {__SET_VAR(data__->,__action_list[__SFC_SIMULAZIONETASTOON].state,,1);};
    if (desactivated) {__SET_VAR(data__->,__action_list[__SFC_SIMULAZIONETASTOON].state,,0);};
  ...
  // CARICOBUSTA action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,TASTOCARICOBUSTA,,1);};
    if (desactivated) {__SET_VAR(data__->,TASTOCARICOBUSTA,,0);};
  ...
  // PRONTALAVORAZIONE action associations
  {
    ...
    if (active && __time_cmp(data__->PRONTALAVORAZIONE.T.value, __time_to_timespec(1, 0, 3, 0, 0, 0)) >= 0) 
  ...
  if (data__->__action_list[__SFC_TASTOCARICOBUSTA].reset) {
    __SET_VAR(data__->,TASTOCARICOBUSTA,,0);
  }
  else if (data__->__action_list[__SFC_TASTOCARICOBUSTA].set) {
    __SET_VAR(data__->,TASTOCARICOBUSTA,,1);
  }
  ...
  if(__GET_VAR(data__->__action_list[__SFC_SIMACCMAN].state)) {
    __SET_VAR(data__->,ACCENSIONEMAN,,__BOOL_LITERAL(TRUE));
  }

  if(__GET_VAR(data__->__action_list[__SFC_SIMULAZIONETASTOON].state)) {
    __SET_VAR(data__->TP0.,IN,,__BOOL_LITERAL(TRUE));
    __SET_VAR(data__->TP0.,PT,,__GET_VAR(data__->TIME3,));
    TP_body__(&data__->TP0);
    __SET_VAR(data__->,TASTOON,,__GET_VAR(data__->TP0.Q,));
  }
  ...
  if(__GET_VAR(data__->__action_list[__SFC_CARICO_BUSTA].state)) {
    ...
    __SET_VAR(data__->RISPRMIOENERGETICO0.,TEMPO,,__GET_VAR(data__->TIME8,));
  ...
  if(__GET_VAR(data__->__action_list[__SFC_PRONTA_LAVORAZIONE].state)) {
    ...
    __SET_VAR(data__->RISPRMIOENERGETICO1.,TEMPO,,__GET_VAR(data__->TIME8,));
  ...
  if(__GET_VAR(data__->__action_list[__SFC_STAMPACALDO].state)) {
    ...
    __SET_VAR(data__->R_TRIG1.,CLK,,__GET_VAR(data__->STATOSTAMPAACALDO,));
    R_TRIG_body__(&data__->R_TRIG1);
    __SET_VAR(data__->CTU0.,CU,,__GET_VAR(data__->R_TRIG1.Q,));
    __SET_VAR(data__->CTU0.,PV,,__GET_VAR(data__->NUM,));
...
#undef __SFC_SIMACCMAN
#undef __SFC_SIMULAZIONETASTOON
