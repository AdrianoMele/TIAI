...
#define __SFC_SVUOTANASTRO 4
#define __SFC_CONTROLLOLAMA 5
#define __SFC_CONTROLLOSTAMPAACALDO 6
#define __SFC_CARICO_BUSTA 7
#define __SFC_SIMULAZIONETASTOEMERGENZA 8
