...
#define __SFC_TASTOCARICOBUSTA 28
#define __SFC_TASTOOFF 29
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  // CARICOBUSTA action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,TASTOOFF,,1);};
    if (desactivated) {__SET_VAR(data__->,TASTOOFF,,0);};
  ...
  if (data__->__action_list[__SFC_TASTOOFF].reset) {
    __SET_VAR(data__->,TASTOOFF,,0);
  }
  else if (data__->__action_list[__SFC_TASTOOFF].set) {
    __SET_VAR(data__->,TASTOOFF,,1);
  }
