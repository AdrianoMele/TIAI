...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  // PRELAVORAZIONE2 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,SENSORETEMP,,1);};
    if (desactivated) {__SET_VAR(data__->,SENSORETEMP,,0);};
  ...
  if (data__->__action_list[__SFC_SENSORETEMP].reset) {
    __SET_VAR(data__->,SENSORETEMP,,0);
  }
  else if (data__->__action_list[__SFC_SENSORETEMP].set) {
    __SET_VAR(data__->,SENSORETEMP,,1);
  }
