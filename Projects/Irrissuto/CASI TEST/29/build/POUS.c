...
#define __SFC_PRONTA_LAVORAZIONE 7
#define __SFC_PRELAVORAZIONE1NASTRO 8
#define __SFC_FUSTELLATRICE 9
#define __SFC_PRELAVORAZIONE2NASTRO 10
#define __SFC_STAMPACALDO 11
#define __SFC_PREFINELAVORAZIONENASTRO 12
#define __SFC_ACCPROGRAMMATA 13
#define __SFC_LEDROSSO 14
#define __SFC_ATTIVARESETRIPR 15
#define __SFC_ATTIVARESET0 16
#define __SFC_LEDGIALLO 17
#define __SFC_RIPRISTINOX 18
#define __SFC_TEMPOATTESA 19
#define __SFC_VANO 20
#define __SFC_TEMPOATTESA2 21
#define __SFC_TASTOEMERGENZA 22
#define __SFC_TEMPOATTESA3 23
#define __SFC_TASTOON 24
#define __SFC_ATTIVARESET6 25
#define __SFC_TIMEDUMMY1 26
#define __SFC_TASTOCARICOBUSTA 27
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  // PRONTALAVORAZIONE action associations
  {
    ...
    if (active && __time_cmp(data__->PRONTALAVORAZIONE.T.value, __time_to_timespec(1, 0, 2, 0, 0, 0)) >= 0) 
