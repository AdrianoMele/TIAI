...
#define __SFC_RISCALDAMENTOMACCHINA 1
#define __SFC_SVUOTANASTRO 2
#define __SFC_CONTROLLOLAMA 3
#define __SFC_CONTROLLOSTAMPAACALDO 4
#define __SFC_CARICO_BUSTA 5
#define __SFC_PRONTA_LAVORAZIONE 6
#define __SFC_PRELAVORAZIONE1NASTRO 7
#define __SFC_FUSTELLATRICE 8
#define __SFC_PRELAVORAZIONE2NASTRO 9
#define __SFC_STAMPACALDO 10
#define __SFC_PREFINELAVORAZIONENASTRO 11
#define __SFC_ACCPROGRAMMATA 12
#define __SFC_LEDROSSO 13
#define __SFC_ATTIVARESETRIPR 14
#define __SFC_ATTIVARESET0 15
#define __SFC_LEDGIALLO 16
#define __SFC_RIPRISTINOX 17
#define __SFC_TEMPOATTESA 18
#define __SFC_VANO 19
#define __SFC_TEMPOATTESA2 20
#define __SFC_TASTOEMERGENZA 21
#define __SFC_TEMPOATTESA3 22
#define __SFC_TASTOON 23
#define __SFC_ATTIVARESET6 24
#define __SFC_TIMEDUMMY1 25
#define __SFC_LEDVERDE 26
#define __SFC_ATTIVARESET7 27
#define __SFC_TIMEDUMMY2 28
#define __SFC_ATTIVARESET 29
#define __SFC_TIMEDUMMY3 30
#define __SFC_ATTIVARESET2 31
#define __SFC_TIMEDUMMY4 32
#define __SFC_ATTIVARESET3 33
#define __SFC_TIMEDUMMY5 34
#define __SFC_ATTIVARESET4 35
#define __SFC_TIMEDUMMY6 36
#define __SFC_ATTIVARESET5 37
#define __SFC_TIMEDUMMY7 38
#define __SFC_ACCENSIONEMAN 39
#define __SFC_ACCENSIONEAUT 40
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  if(__GET_VAR(data__->__action_list[__SFC_RISCALDAMENTOMACCHINA].state)) {
    ...
    __SET_VAR(data__->RISPRMIOENERGETICO2.,TEMPO,,__GET_VAR(data__->TIME7,));
